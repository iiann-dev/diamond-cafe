    ...
    <div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10 pt-8">
        ...
        <div className="porcelain-card p-8 md:p-12 flex flex-col justify-center">
          ...
          <h1 className="font-display text-display-mobile md:text-display text-rich-charcoal mb-4">
            Our <span className="text-diamond-blue">Story</span>
          </h1>
          <p className="text-muted-charcoal text-body">{SITE.description}</p>
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
        {[
          ...
          >
            <div className="w-12 h-12 rounded-xl bg-diamond-blue/10 flex items-center justify-center mx-auto mb-3 text-diamond-blue">
            ...
            <h3 className="font-display text-heading-sm text-rich-charcoal mb-1">{v.title}</h3>
            <p className="text-muted-charcoal text-body">{v.desc}</p>
          </div>
        ))}
      </section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
        <div className="porcelain-card p-8 md:p-12 flex flex-col justify-center">
          <h2 className="font-display text-heading text-rich-charcoal mb-4">Family-Run Since 2010</h2>
          <p className="text-muted-charcoal text-body mb-3">
            What started as a dream between two siblings has grown into the neighborhood gathering spot it is today.
          </p>
          <p className="text-muted-charcoal text-body">
